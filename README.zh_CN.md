...
TrustDSN 前端页面主要围绕三个核心功能展开：文件信息查询、文件上传和文件检索。

### 文件信息查询

<p align="center">
  <img src="./assets/readme/file_infomation.gif" alt="TrustDSN 文件信息查询演示" width="900">
</p>

查询系统当前记录的文件列表，并查看已经可以被检索的文件信息。

### 文件上传

<p align="center">
  <img src="./assets/readme/file_upload.gif" alt="TrustDSN 文件上传演示" width="900">
</p>

在前端页面中输入工作区文件名，并通过按钮提交存储交易，完成文件上传。

### 文件检索

<p align="center">
  <img src="./assets/readme/file_retrieval.gif" alt="TrustDSN 文件检索演示" width="900">
</p>

通过文件名发起检索请求，将恢复出的文件重新写回本地工作区。
